...
import GITHUBL from '../assets/img/github-light.png'
      ...
      {/*container*/}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                <div className='dark:shadow-[#040C16] hover:scale-110 duration-500'>
                ...
                <div className='dark:shadow-[#040C16] hover:scale-110 duration-500'>
                    <img src={light ? GITHUBL : GITHUB} alt="GITHUBicon" className='w-20 mx-auto'/>
