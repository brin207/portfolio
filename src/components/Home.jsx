    ...
    <div name='home' className='w-full h-screen bg-[#c6c0b8] dark:bg-[#474139]'>
      ...
      {/* container */}
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h2 className='text-4xl sm:text-7xl font-black pb-1 bg-gradient-to-r from-[#be731e] to-[#474700] bg-clip-text text-transparent dark:from-[#e19741] dark:to-[#ffffb8]'> A Software Developer.</h2>
