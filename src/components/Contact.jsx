  ...
  return (
    <div name='contact' className='w-full h-screen dark:bg-black flex justify-center items-center p-4 pt-30'>
      <form method='POST' action='https://getform.io/f/39158c46-0fbb-4625-8a20-b1f6560faf9d' className='flex flex-col max-w-[600px] w-full'>
        ...
        <input className='p-2 bg-[#ececec] focus:outline-none dark:bg-white focus:border-black focus:ring-1 focus:ring-black' type='text' placeholder='Name' name="name" />
        <input className='my-4 p-2 bg-[#ececec] focus:outline-none dark:bg-white focus:border-black focus:ring-1 focus:ring-black' type='email' placeholder='Email' name="email" />
        <textarea style={{minHeight:"250px"}} className='p-2 bg-[#ececec] dark:bg-white focus:outline-none focus:border-black focus:ring-1 focus:ring-black' name='message' rows='10' placeholder='Message'></textarea>
